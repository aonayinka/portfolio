...
const SecondSkills = () => {
  return (
    <section id='skills__sec'>
        ...
        <span className='skill__Desc'> Lorem ipsum, dolor sit amet consectetur adipisicing elit. A sint perferendis quia, tenetur enim ducimus dolor minima aliquid odit veritatis inventore possimus, harum, suscipit reiciendis sit molestias dicta. Perspiciatis, iusto!</span>
            ...
            <div className="skill__bar">
                ...
                <div className="skillBar__text">
                    ...
                    <p>Familiarity with version control tools like Git, 
                        including branching, merging, and collaborating with 
                        teams using platforms like GitHub.</p>
                </div>
            </div>
        </div>
        <div className='skill__Bars'>
